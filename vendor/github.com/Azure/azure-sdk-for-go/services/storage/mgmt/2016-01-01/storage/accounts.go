...
func (client AccountsClient) CheckNameAvailability(accountName AccountCheckNameAvailabilityParameters) (result CheckNameAvailabilityResult, err error) {
	azs.Trace("[TRACE] CheckNameAvailability():Enter")
	...
	if err != nil {
		azs.Error("[ERROR] CheckNameAvailability():Exit")
...
func (client AccountsClient) CheckNameAvailabilityPreparer(accountName AccountCheckNameAvailabilityParameters) (*http.Request, error) {
	azs.Trace("[TRACE] CheckNameAvailabilityPreparer():Enter")
	...
	azs.Trace("[TRACE] CheckNameAvailabilityPreparer():Exit")
...
func (client AccountsClient) CheckNameAvailabilitySender(req *http.Request) (*http.Response, error) {
	azs.Trace("[TRACE] CheckNameAvailabilitySender():Enter-Exit")
...
func (client AccountsClient) CheckNameAvailabilityResponder(resp *http.Response) (result CheckNameAvailabilityResult, err error) {
	azs.Trace("[TRACE] CheckNameAvailabilityResponder():Enter")
	err = autorest.Respond(
		...
		autorest.ByClosing())
	result.Response = autorest.Response{Response: resp}
	azs.Trace("[TRACE] CheckNameAvailabilityResponder():Exit")
	return
}
...
func (client AccountsClient) Create(resourceGroupName string, accountName string, parameters AccountCreateParameters, cancel <-chan struct{}) (<-chan Account, <-chan error) {
	azs.Trace("[TRACE] Create():Enter")
	azs.Debug("[DEBUG] Create():resourceGroupName %s", resourceGroupName)
	azs.Debug("[DEBUG] Create():accountName %s", accountName)
...
func (client AccountsClient) CreatePreparer(resourceGroupName string, accountName string, parameters AccountCreateParameters, cancel <-chan struct{}) (*http.Request, error) {
	azs.Trace("[TRACE] CreatePreparer():Enter")
	azs.Debug("[DEBUG] CreatePreparer():resourceGroupName %s", resourceGroupName)
	azs.Debug("[DEBUG] CreatePreparer():accountName %s", accountName)
	pathParameters := map[string]interface{}{
		"accountName":       autorest.Encode("path", accountName),
		"resourceGroupName": autorest.Encode("path", resourceGroupName),
		"subscriptionId":    autorest.Encode("path", client.SubscriptionID),
	}
	azs.Debug("[DEBUG] CreatePreparer():accountName %s", pathParameters["accountName"])
	azs.Debug("[DEBUG] CreatePreparer():resourceGroupName %s", pathParameters["resourceGroupName"])
	azs.Debug("[DEBUG] CreatePreparer():subscriptionId %s", pathParameters["subscriptionId"])
	...
	preparer := autorest.CreatePreparer(
		...
		autorest.WithQueryParameters(queryParameters))
	azs.Trace("[TRACE] CreatePreparer():Exit")
...
func (client AccountsClient) CreateSender(req *http.Request) (*http.Response, error) {
	azs.Trace("[TRACE] CreateSender():Enter-Exit")
	return autorest.SendWithSender(client,
		req,
		azure.DoRetryWithRegistration(client.Client),
...
func (client AccountsClient) CreateResponder(resp *http.Response) (result Account, err error) {
	azs.Trace("[TRACE] CreateResponder():Enter")
	err = autorest.Respond(
		resp,
		client.ByInspecting(),
		...
		autorest.ByClosing())
	result.Response = autorest.Response{Response: resp}
	azs.Trace("[TRACE] CreateResponder():Exit")
	return
}
...
func (client AccountsClient) ListAccountSASPreparer(resourceGroupName string, accountName string, parameters AccountSasParameters) (*http.Request, error) {
	...
	azs.Debug("[DEBUG] ListAccountSASPreparer():accountName %s", pathParameters["accountName"])
	azs.Debug("[DEBUG] ListAccountSASPreparer():resourceGroupName %s", pathParameters["resourceGroupName"])
	azs.Debug("[DEBUG] ListAccountSASPreparer():subscriptionId %s", pathParameters["subscriptionId"])
...
func (client AccountsClient) UpdatePreparer(resourceGroupName string, accountName string, parameters AccountUpdateParameters) (*http.Request, error) {
	...
	azs.Debug("[DEBUG] UpdatePreparer():accountName %s", pathParameters["accountName"])
	azs.Debug("[DEBUG] UpdatePreparer():resourceGroupName %s", pathParameters["resourceGroupName"])
	azs.Debug("[DEBUG] UpdatePreparer():subscriptionId %s", pathParameters["subscriptionId"])
